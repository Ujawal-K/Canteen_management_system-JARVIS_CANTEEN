...
{
    system("CLS");
    gotoxy(40,1);cout<<"  JARVIS CANTEEN ";
...
void store::price()
{
    ...
    gotoxy(40,0);cout<<"JARVIS CANTEEN";
    gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
...
class login
{
  public:
      ...
      {
          system("CLS");
          gotoxy(40,1);cout<<"WELCOME TO JARVIS CANTEEN";
          gotoxy(40,2);cout<<"----------------------------"<<endl<<endl;
          cout<<"     1. LOGIN"<<endl;
...
int main()
{
    system("title CANTEEN MANAGEMENT SYSYTEM - JARVIS CANTEEN ");
    system("color 71");
    login l;
    l.homepage();
    return 0;
